...
### 构建完成
- **感知机**：包含原始感知机和现代可微分版本的实现与数学推导

### 正在构建
- **多层感知机**：全连接神经网络的前向传播与反向传播实现
...
### 文件夹类别
1. `note` 文件夹：该文件夹下是各个组件的数学推导笔记，包含基础概念和推导过程
2. `src` 文件夹：该文件夹下是各个组件的具体代码实现，注释中包含工程实现中的注意重点
3. `test` 文件夹：该文件夹下是测试文件，用于在开发过程中进行验证纠错
